...
type Options struct {
	...
	Address sfconnection.AMAddr  `short:"a" long:"address" default:"0001" description:"Local address"`
...
func mainfunction() int {
	...
	ss := rtcsync.NewSyncSender(sfc, opts.Address, opts.Group, opts.NtpHost)
